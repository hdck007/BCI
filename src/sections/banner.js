      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            <Heading as="h1">
              Transform Your Business with Business Click India
            </Heading>
            <Text as="p">
              Get everything to succeed online with our comprehensive digital
              services - web design, digital marketing, and B2B solutions.
            </Text>
