          ...
          <div sx={styles.content}>
            <div sx={styles.heading}>
              ...
              <Text as="p" sx={styles.summary}>
                We're committed to your satisfaction, and we stand behind our
                services. If for any reason you're not satisfied with our
                services, we'll work with you to make it right.
              </Text>
            </div>
            {/* <SectionHeading
              sx={styles.heading}
              title="Do you need help? Our support team ready to help you"
              description=" at let home collect sample from the victory of the managements that supplies best design system guidelines ever."
            /> */}
            {data.map((support) => (
